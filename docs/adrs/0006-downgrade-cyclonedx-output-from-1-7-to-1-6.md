# 0006. Downgrade CycloneDX Output from 1.7 to 1.6
...
Supersedes ADR 0005 (CycloneDX 1.7 only initially). ADR 0005 chose to
target only CycloneDX 1.7; this ADR reverses that decision because our
quality scoring toolchain (sbomqs) does not yet support 1.7. The intent
remains to return to 1.7 once sbomqs catches up.
